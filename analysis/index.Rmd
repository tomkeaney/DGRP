...
**Must check Harrison et al 2020 data. Supplied by MK but I'm not sure where from. They have data on github but it is poorly annotated, so very hard to model.** 
...
4. [Running genome-wide association tests](run_GWAS.html), which describes how GWA tests were run and shows some summary statistics.

5. [Cross phenotype meta analysis](cross_phenotype_meta_analysis.html), which details our CPMA analysis seraching for pleiotopic variants.

We also [provide a guide](How_to.html) to uploading your own data, so that this resource can remain current.
