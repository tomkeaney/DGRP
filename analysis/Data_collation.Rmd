...
Duneau_2018_deltamethrin_data <- read_csv("data/input/Duneau_2018/Duneau_2018_deltamethrin.csv") %>% 
...
Duneau_2018_parathion_data <- read_csv("data/input/Duneau_2018/Duneau_2018_parathion.csv") %>% 
   mutate(line = str_remove(DGRP_lines, "line_"),
          Experiment = as.factor(Experiment)) %>% 
  mutate(line = as.factor(line),
...
Zwoinska_male_data <- read_csv("data/input/Zwoinska_2020/Zwoinska_males_2020.csv") %>% 
  rename(line = DGRP) %>% 
  mutate(line = as.factor(line),
...
Zwoinska_female_data <- read_csv("data/input/Zwoinska_2020/Zwoinska_females_2020.csv") %>% 
  rename(line = DGRP) %>% 
  mutate(line = as.factor(line),
         Batch = as.factor(Batch),
         Temperature_new = recode(Temperature,
