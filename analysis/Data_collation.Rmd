...
We also here save a list of references that appear in the original database, which is used to ensure that the analyses in the paper can be faithfully reproduced if new datasets are added later.

```{r}
tibble(Reference = unique(meta_data$Reference)) %>% 
  write_csv("data/input/references_in_original_database.csv")
```
