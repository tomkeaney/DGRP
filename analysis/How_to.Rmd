...
```{r}
tibble("line" = "In each row list the DGRP line number e.g. 26", "Trait" = "trait name", "Sex" = "e.g. Female", "trait_value" = "In each row list the trait value for the specified DGRP line", "Trait guild" = "e.g. Life history",  "Trait description" = "Short explanation of your trait", "Reference" = "e.g. Mackay et al (2012) Nature") %>% 
...
**Should I also include more columns like DOI/URL or various meta-data things?**
